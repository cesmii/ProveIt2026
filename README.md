...
This repo contains the slides from that presentation, as well as sub-folders/modules for additional resources. We used a [framework built by NextStep products](https://github.com/Chad-NextStep/WebPresentationTemplate), you can [view it as a presentation via GitHub Pages](https://cesmii.github.io/ProveIt2026/). This content preserved for posterity and will not be updated.
